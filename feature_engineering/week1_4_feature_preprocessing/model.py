...
CSV_COLUMNS = (
    ...
    'dropofflon,dropofflat,passengers,key'.split(',')
)
...
# Create feature engineering function that will be used in the input and
...
def serving_input_fn():
    feature_placeholders = {
        ...
        column.name: tf.placeholder(tf.float32, [None]) for column in
        INPUT_COLUMNS[2:7]
    }
