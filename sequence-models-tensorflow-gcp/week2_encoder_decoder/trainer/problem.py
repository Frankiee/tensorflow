...
# ### Set up problem ###
# ######################
# The Problem in tensor2tensor is where you specify parameters like the size of
# your vocabulary and where to get the training data from.
...
class PoetryLineProblem(text_problems.Text2TextProblem):
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        with open('poetry_raw.txt', 'r') as rawfp:
            prev_line = ''
